...
@Component
public class CustomAuthentificationSucccessHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		System.out.println("A User with username "+username+" is logged in.");
